...
"var s=document.createElement('span');s.className='ts';s.textContent='['+ts+'] ';"
"d.appendChild(s);d.appendChild(document.createTextNode(t));}"
...
"if(i>=0){var h=document.createElement('div');h.className='msg sys';"
"h.textContent=t.slice(i+1);document.getElementById('msgs').appendChild(h);}"
