...
"<style>"
"body{background:#111;color:#ddd;font-family:ui-monospace,Menlo,monospace;margin:0}"
"#login{max-width:320px;margin:20vh auto;padding:24px;background:#1a1a1a;border:1px solid #333;border-radius:8px}"
...
"#chat{display:none;max-width:720px;margin:0 auto;padding:12px;height:100vh;box-sizing:border-box;display:none}"
"#msgs{overflow-y:auto;height:calc(100vh - 60px);padding:4px 0}"
...
"d.textContent=t;document.getElementById('msgs').appendChild(d);"
